...
route.get('/', (req, res, next)=>{
    ...
    if (sid && authCookies[sid]){ //проверяем наличие cookies и наличие разрешения/*Разрешение есть. Функция рендер наполняет шаблон (файл admin_panel.mustache) данными указанными вторым аргументом*/
